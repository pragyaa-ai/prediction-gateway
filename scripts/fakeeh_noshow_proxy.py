...
USE_LOCAL_PRIMARY = env_bool("NOSHOW_USE_LOCAL_PRIMARY", "USE_LOCAL_PRIMARY", default="true")
CLOUD_ENABLED = env_bool("NOSHOW_CLOUD_ENABLED", "CLOUD_ENABLED", default="false")
